...
// Attachments are deliberately not wired up: `useLocalRuntime` is given no
// attachment adapter, and Sage's /chat contract takes text only. The pieces
// are still in `@/components/attachment` for when that changes.
...
const Composer: FC = () => {
  return (
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      {/* A plain shell rather than ComposerPrimitive.AttachmentDropzone —
          otherwise dragging a file still lights up a drop target that cannot
          accept it. */}
...
const ComposerAction: FC = () => {
  // justify-end, not justify-between: the add-attachment button used to hold
